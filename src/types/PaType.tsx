...
export const profilWisata: ProfilWisataProps[] = [
  {
    ...
    wisataDesc: `Pindah Alam adalah destinasi wisata yang menawarkan pengalaman menyatu dengan keindahan alam. Terletak di kawasan yang jauh dari kebisingan kota, tempat ini menyajikan pemandangan memukau berupa hamparan hijau pepohonan, perbukitan yang menyejukkan mata, dan aliran sungai jernih yang menghadirkan ketenangan. Udara segar yang menyelimuti area ini membuatnya sempurna untuk melepas penat dan menyegarkan pikiran.

Sebagai destinasi yang mengedepankan suasana tenang, Pindah Alam lebih memprioritaskan kunjungan pasangan suami istri (pasutri). Untuk menjaga kenyamanan dan nilai-nilai yang dijunjung tinggi, pengelola melarang remaja cowok dan cewek untuk berada bersama dalam satu tenda. Selain itu, demi mempertahankan konsep ketenangan alam, pengunjung tidak diperkenankan menyalakan musik. Harmoni alami dari suara gemericik air, kicauan burung, dan hembusan angin menjadi elemen utama yang ingin dipertahankan.

Beragam aktivitas dapat dinikmati di sini, seperti hiking menyusuri jalur alam, piknik santai bersama pasangan, atau sekadar duduk menikmati pemandangan alam yang memanjakan jiwa. Fasilitas ramah lingkungan juga disediakan untuk mendukung kenyamanan tanpa mengganggu ekosistem sekitar.

Bagi pengunjung yang ingin pengalaman lebih dekat dengan alam, Pindah Alam menawarkan area perkemahan yang aman dan nyaman. Di malam hari, langit yang dipenuhi bintang menjadi daya tarik utama, menciptakan suasana magis yang sulit dilupakan. Tempat ini benar-benar memberikan momen berharga yang menghubungkan pengunjung dengan keindahan dan ketenangan alam.`,
  },
];
