          ...
          >
            ...
            <div className="card-body p-6">
              ...
              <div className="flex justify-center pt-10">
                <button onClick={()=>navigate(item.navigate)} className="text-sm md:text-base text-green-600 bg-green-50 py-2 px-7 rounded-md shadow hover:bg-green-100 transition md:px-6 md:py-3 justify-center flex items-center space-x-3">
                  <p>Selengkapnya</p>
                  <MdArrowForward />
                </button>
              </div>
